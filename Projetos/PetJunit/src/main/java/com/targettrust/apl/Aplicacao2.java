...
public class Aplicacao2 {
	...
	try {
	    ...
	    Cliente cliente = new Cliente(1l, "45", "Zé Ninguem", null, null, null);
	...
	if (p.getAnimal() == null) {
	    System.out.println("Não existe animal para a imprimir relatorio de Pessoa Animal");
	} else {
	    System.out.println("Cliente: " + p.getNome() + " - Identificador: " + p.getIdentificador());
