...
import com.targettrust.model.Funcionario;
import com.targettrust.model.Vendedor;
...
public class Aplicacao {
	...
	SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
	if (f == null) {
	    System.out.println("Não existe funcionario para a imprimir relatorio");
	} else {
	    System.out.println("Funcionario: " + f.getNome() + " - Identificador: " + f.getIdentificador());
	    System.out.println("-----------------------------------------------------------");
