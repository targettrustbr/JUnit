...
public class Animal {
     ...
     */
    public Animal(String parametroApelido, float parametroPeso, int parametroAltura, boolean parametroVivo, Especie parametroEspecie) throws ValidacaoException {
	...
	if (parametroPeso < 0 || parametroPeso > 200)
	    throw new ValidacaoException("Peso Invalido tem que estar entre 1 e 200kg");
