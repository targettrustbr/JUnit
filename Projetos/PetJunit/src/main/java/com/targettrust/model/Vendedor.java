...
public class Vendedor extends Funcionario {
     ...
     */
    public Vendedor(long parametroCodigo, String parametroIdentificador, String parametroNome, Date parametroDataCadastro, Date parametroDataNascimento,
	    float parametroSalario, String parametroCargo, float parametroComissao) {
	super(parametroCodigo, parametroIdentificador, parametroNome, parametroDataCadastro, parametroDataNascimento, parametroSalario, parametroCargo);
